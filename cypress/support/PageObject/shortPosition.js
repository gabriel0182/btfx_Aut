class shortPosition {
	...
	testSortingPositions() {
		const pairUP = cy
			.get('[style="flex: 1 1 160px; min-width: 160px;"] > .table__title-titlewrapper')
			.get(
		...
		const liqPriceUp = cy
			.get('[style="flex: 1 1 160px; min-width: 160px;"] > .table__title-titlewrapper')
			.get('[style="flex: 1 1 110px; min-width: 75px;"] > .table__title-titlewrapper')
			.get('[style="flex: 1 1 110px; min-width: 75px;"] > .table__title-titlewrapper > .sort-icons')
			.click()
			.get('[style="flex: 1 1 110px; min-width: 75px;"] > .virtable__cellwrapper > span')
			.should($val => {
				expect($val).not.to.be.null
			})
		...
		const plPerUp = cy
			.get('[style="flex: 1 1 160px; min-width: 160px;"] > .table__title-titlewrapper')
			.get(
				'[data-qa-id="positions-table"] > [style="overflow: visible; height: 0px; width: 0px;"] > [tabindex="-1"] > .table-vir__header > :nth-child(8) > .table__title-titlewrapper'
			)
			.get(
				'[data-qa-id="positions-table"] > [style="overflow: visible; height: 0px; width: 0px;"] > [tabindex="-1"] > .table-vir__header > :nth-child(8) > .table__title-titlewrapper > .sort-icons > .fa-sort-up'
			)
			.click()
		...
		const fundingCostUp = cy
			.get('[style="flex: 1 1 160px; min-width: 160px;"] > .table__title-titlewrapper')
			.get(
				'[style="flex: 1 1 120px; min-width: 100px; display: flex; justify-content: flex-end;"] > .table__title-titlewrapper'
			)
			.get(
				'[style="flex: 1 1 120px; min-width: 100px; display: flex; justify-content: flex-end;"] > .table__title-titlewrapper > .sort-icons > .fa-sort-up'
			)
			.click()
		...
		const fundingCostDown = cy
			...
			.get('[style="flex: 1 1 25px; min-width: 25px; max-width: 25px;"] > .show50')
			.should('contain', 'BTC')
		const fundingTypeUp = cy
			.get('[style="flex: 1 1 160px; min-width: 160px;"] > .table__title-titlewrapper')
			.get(
				'[data-qa-id="positions-table"] > [style="overflow: visible; height: 0px; width: 0px;"] > [tabindex="-1"] > .table-vir__header > :nth-child(11) > .table__title-titlewrapper'
			)
			.get(
				'[data-qa-id="positions-table"] > [style="overflow: visible; height: 0px; width: 0px;"] > [tabindex="-1"] > .table-vir__header > :nth-child(11) > .table__title-titlewrapper > .sort-icons > .fa-sort-up'
			)
			.click()
			.get('[style="height: 25px; width: 100%;"] > .table-vir__row > :nth-child(11) > div')
			.get('.btn-flat > span')
			.should('contain', 'Daily')
		const fundingTypeDown = cy
			.get('[style="flex: 1 1 160px; min-width: 160px;"] > .table__title-titlewrapper')
			.get(
				'[data-qa-id="positions-table"] > [style="overflow: visible; height: 0px; width: 0px;"] > [tabindex="-1"] > .table-vir__header > :nth-child(11) > .table__title-titlewrapper'
			)
